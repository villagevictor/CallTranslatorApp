...
class MainActivity : Activity() {
    ...
    // 📖 200 ከመስመር ውጭ የዕለት ተዕለት ንግግሮች (0% Crash Risk)
    private val offlineDictionary = HashMap<String, String>().apply {
        ...
        put("did you sleep well", "ደህና አደርክ / አደርሽ?")
        put("i want to take a shower", "መታጠብ (ሻወር መውሰድ) እፈልጋለሁ")
    ...
    private fun startTranslationEngine() {
        ...
        Toast.makeText(this, "🚀 200+ ከመስመር ውጭ ንግግሮች ዝግጁ ሆነዋል!", Toast.LENGTH_SHORT).show()
    }
    ...
    private fun showNotification() {
        ...
        val notification = Notification.Builder(this, channelId)
            ...
            .setContentText("ገበያ እና ምግብ ንግግሮች በንቃት ላይ...")
    ...
    private fun setupOverlay() {
        ...
        overlayTextView = TextView(this).apply {
            ...
            setBackgroundColor(0xEE220066.toInt())
